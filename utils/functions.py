...
def read_instance(input_file, word_alphabet, char_alphabet, feature_alphabets, label_alphabet, number_normalized,
    ...
    '''
    处理数据集 提取出 word char feature label 的文本以及对应的 id
    :param input_file: 数据集
    :param word_alphabet: 单词 alphabet
    :param char_alphabet: 字符 alphabet
    :param feature_alphabets: 特征 alphabet
    :param label_alphabet: 标签 alphabet
    :param number_normalized: 是否对 number 进行标准化
    :param max_sent_length: 最大 sentence 长度
    :param sentence_classification: 是否是句子分类任务
    :param split_token: 分割 token
    :param char_padding_size: 字符 padding 后的 size
    :param char_padding_symbol: padding 字符
...
def build_pretrain_embedding(embedding_path, word_alphabet, embedd_dim=100, norm=True):
    '''
    处理并返回嵌入矩阵与嵌入维度
    :param embedding_path: embedding 文件位置
    :param word_alphabet: alphabet
    :param embedd_dim: embedding 维度
    :param norm: embedding 是否标准化
